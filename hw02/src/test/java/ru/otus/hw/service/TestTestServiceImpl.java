...
class TestTestServiceImpl {
    ...
    void setUp() {
        ...
        testService = new TestServiceImpl(ioService, questionDao, questionStringConverter);
    ...
    void executeTestForShouldReturnTestResult() {
        ...
        when(ioService.readIntForRangeWithPrompt(1, 2, "Formatted Question 1", "Invalid answer format"))
                .thenReturn(1);
        when(ioService.readIntForRangeWithPrompt(1, 2, "Formatted Question 2", "Invalid answer format"))
                .thenReturn(1);
        ...
        verify(ioService).readIntForRangeWithPrompt(1, 2, "Formatted Question 1", "Invalid answer format");
        verify(ioService).readIntForRangeWithPrompt(1, 2, "Formatted Question 2", "Invalid answer format");
    }
    ...
    void executeTestForShouldApplyCorrectAnswers() {
        ...
        when(ioService.readIntForRangeWithPrompt(1, 2, "Formatted Test Question", "Invalid answer format"))
                .thenReturn(1);
